export const secondaryButtonClass =
  "rounded-md border border-zinc-300 px-2 py-[6px] text-sm hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-900 disabled:opacity-50 disabled:cursor-not-allowed";
